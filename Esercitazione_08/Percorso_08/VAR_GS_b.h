...
double delta_mu; //Ampiezze degli intervalli in cui pesco mu e sigma.
double delta_sigma; //Va bene anche la coppia 1.5 e 0.75, con accettazione del 68%.
...
int annealing = 1; //Numero di cicli sulla temperatura. 
